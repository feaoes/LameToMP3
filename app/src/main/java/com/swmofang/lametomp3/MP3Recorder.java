...
public class MP3Recorder {
	...
	public void start() {
		...
		new Thread() {
			@Override
			public void run() {
//				String fileDir = Environment.getExternalStorageDirectory() + "LameMP3/Voice/";
 
				File dir = new File(Environment.getExternalStorageDirectory(),"LameMP3/Voice/");
				if (!dir.exists()) {
					dir.mkdirs();
				}
 
				mFilePath = Environment.getExternalStorageDirectory() + "/LameMP3/Voice/"
